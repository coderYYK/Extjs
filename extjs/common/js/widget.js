...
Ext.define("MyCim.form.field.SearchField", {
  ...
  doSearch: function (type, multiRows, targetIds, referceIds, callback, value, paramStr, width, height, callbackClick, callbackFlag) {
    if (callback != null) {
      var url =
        "/mycim2/searchAction.do?reqCode=init&type=" +
        type +
        "&multiRows=" +
        multiRows +
        "&targetIds=" +
    ...
    window.open(
      url,
      "poppage",
      "toolbars=0, scrollbars=0, location=0, statusbars=0, menubars=0, resizable=1, width=" + width + ", height=" + height + ""
    )
  }
})
...
Ext.define("MyCim.form.field.SearchField2", {
  ...
  doSearch: function (type, multiRows, targetIds, referceIds, callback, value, paramStr, width, height, callbackClick, callbackFlag) {
    if (callback != null) {
      var url =
        "/mycim2/searchAction2.do?reqCode=init&type=" +
        type +
        "&multiRows=" +
        multiRows +
        "&targetIds=" +
...
Ext.define("MyCim.form.field.WflInfoField", {
  ...
  doSearchForWflInfo: function (type, targetIds, value, paramStr, width, height, callbackFlag) {
    ...
    window.open(
      url,
      "WflInfo_Window",
      "toolbars=0, scrollbars=0, location=no, statusbars=0, menubars=0, resizable=1, width=" + width + ", height=" + height + ""
    )
  }
})
...
Ext.define("MyCim.form.field.clearField", {
  extend: "Ext.form.field.Trigger",
